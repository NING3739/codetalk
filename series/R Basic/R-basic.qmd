...
In Section, we will introduce you to R Basics, Functions, and Datatypes.
...
# Vectors, Sorting
In this Section, we will introduce you to vectors and functions such as sorting.
...
In this section, we will introduce the R commands and techniques that help you wrangle, analyze, and visualize data.

In Indexing, you will:
...
In basic plots, you will:
- Plot data in scatter plots, box plots, and histograms. 

In summarizing with dplyr, you will:
...
# Programming Basics
In this section,  we will introduce you to general programming features like 'if-else' and 'for loop' commands so that you can write your own functions to perform various operations on datasets.
