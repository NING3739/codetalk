...
# Gapminder
## Overview
After completing Gapminder, you will:
...
We will use this data to answer the following questions about World Health and Economics:
...
[ggplot2-[分面(facet) 一页多图](https://blog.csdn.net/tanzuozhev/article/details/51112177)]{.aside}
[数据可视化章节学习[facet](https://zhuanlan.zhihu.com/p/31044450)]{.aside}
